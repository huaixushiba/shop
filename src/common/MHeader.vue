      ...
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/"
                           title="商城官网">Xmall商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
            ...
            <div class="nav-aside">
                  ...
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li class="nav-user-avatar">
                        <div>
                          <span class="avatar"
                                :style="{backgroundImage:'url('+userInfo.file+')'}"></span>
                        </div>
              ...
              <div class="shop pr"
                ...
                <span class="cart-num">
                  <i class="num"
                     :class="{no:totalNum == 0}">{{totalNum}}</i>
                </span>
                ...
                <div class="nav-user-wrapper pa active"
                  ...
                  <div class="nav-user-list">
                    ...
                    <div style="height: 313px;text-align: center"
                         class="cart-con"
                         v-if='!totalNum'>
                      <p>您的购物车竟然是空的!</p>
                    </div>
...
export default {
  ...
  async mounted () {
    if (this.login) {
      const res = await this.$http.post('/cartList', { userId: getStore('id') })
